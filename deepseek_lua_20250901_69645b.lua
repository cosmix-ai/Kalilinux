...
local v = "1.4" -- Updated version with glass theme
...
local function createBlurEffect(parent)
    ...
    blur.Size = guiSettings.blurIntensity
    blur.Parent = parent
    return blur
end
...
local blurEffect = createBlurEffect(game.Lighting)
...
function loadMainGUI()
    ...
    featureScroll.CanCanvasSize = UDim2.new(0, 0, 0, 0)
